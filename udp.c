...
int main(int argc, char *argv[ ])
{
  if(argc < 5){
    ...
    fprintf(stdout, "Usage: %s <IP> <port> <throttle> <threads> <time>\n", argv[0]);
    exit(-1);
  }
  ...
  fprintf(stdout, "Starting Flood... FREE Bitcoin - http://fumacrom.com/3SMYx * Work at Home - http://fumacrom.com/3SMYT * Get Paid to share links - https://bit.ly/3zI3oWG \n");
  if(argc > 5)
  {
    sleep(atoi(argv[5]));
  } else {
